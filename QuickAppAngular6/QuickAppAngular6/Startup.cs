...
using QuickAppAngular6.Authorization;
using QuickAppAngular6.Helpers;
using QuickAppAngular6.ViewModels;
using Swashbuckle.AspNetCore.Swagger;
using System;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace QuickAppAngular6
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("QuickAppAngular6"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "QuickAppAngular6 API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "QuickAppAngular6 API V1");
            });
